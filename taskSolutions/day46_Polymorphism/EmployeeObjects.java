...
public class EmployeeObjects {
    public static void main(String[] args) {
        ...
        Employee developerWithMaxSalary = developers.get(0);
        ...
        for (Employee employee : employees) {
            ...
            if(employee instanceof Tester) {
                if(employee.getSalary() >= testerWithMaxSalary.getSalary()) {
                    testerWithMaxSalary = employee;
                }
            } else if(employee instanceof Developer) {
                if(employee.getSalary() >= developerWithMaxSalary.getSalary()) {
                    developerWithMaxSalary = employee;
                }
            }
        }

        System.out.println("Tester with the maximum salary: " + testerWithMaxSalary);
        System.out.println("Developer with the maximum salary: " + developerWithMaxSalary);
    }
}
